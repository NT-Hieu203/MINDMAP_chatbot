...
def create_ontology(merged_nodes, save_path, ontology_iri="http://www.semanticweb.org/MINDMAP"):
    """
    ...
    if root_node_info:
        ...
        with onto:
            ...
            add_annotation_to_class(onto, main_root_class, root_node_info, merged_nodes)
