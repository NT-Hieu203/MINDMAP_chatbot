...
<template>
    <div class="home-page-container">
      <h1>Chào mừng đến với ứng dụng Ontology Mindmap!</h1>
      <p>Sử dụng ứng dụng để tạo Mindmap từ tài liệu PDF của bạn hoặc khám phá Mindmap mặc định.</p>
      <div class="navigation-cards">
        ...
        <div class="card" @click="goToDefaultChat">
          <h2>Khám phá Mindmap mặc định</h2>
          <p>Trò chuyện với Ontology có sẵn về kiến thức chung.</p>
      ...
      <div class="app-description">
        ...
        <ul>
          ...
          <li>Hỗ trợ Mindmap mặc định cho các chủ đề chung.</li>
        </ul>
      </div>
    </div>
  </template>
